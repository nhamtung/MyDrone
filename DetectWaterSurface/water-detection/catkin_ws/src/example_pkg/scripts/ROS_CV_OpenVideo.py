...
# RUN
# $rosrun example_pkg ROS_CV_OpenVideo.py rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov
# $rosrun example_pkg ROS_CV_OpenVideo.py /home/nhamtung/TungNV/MyDrone/DetectWaterSurface/water-detection/catkin_ws/src/example_pkg/video/MavicProPrecisionLanding2.mkv

import cv2
import sys

if __name__ == '__main__':
  print ("INFO - sys.argv: " + sys.argv[1])
  if len(sys.argv) < 2:
